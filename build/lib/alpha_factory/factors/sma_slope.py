...
try:
    ...
    registry.register(FactorSpec(name="sma_slope_20_1", factory=lambda: SMASlope(n=20, lookback=1)))
    registry.register(FactorSpec(name="sma_slope_50_1", factory=lambda: SMASlope(n=50, lookback=1)))
